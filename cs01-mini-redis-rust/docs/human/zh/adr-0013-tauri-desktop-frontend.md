...
M4.4 full-bundle gate 曾因 npm Tauri 2.9.x 与 Rust `tauri` 2.11.1 minor mismatch 失败;修复为显式 pin `@tauri-apps/api`/`@tauri-apps/cli` 到 2.11.0、`tauri` 到 2.11.1、`tauri-build` 到 2.6.1,避免 lockfile 再生成时回漂。
